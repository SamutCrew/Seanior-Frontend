...
export default function StudentEnrollmentDetailsPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className={`min-h-screen ${isDarkMode ? "bg-slate-900 text-white" : "bg-white text-slate-900"} p-6`}>
        ...
        <div
          className={`p-8 text-center rounded-lg border-2 border-dashed ${isDarkMode ? "border-slate-700 text-gray-400" : "border-slate-300 text-gray-500"}`}
        >
  ...
  if (isLoading) {
    return (
      <div
        className={`min-h-screen flex items-center justify-center ${isDarkMode ? "bg-slate-900 text-white" : "bg-white text-slate-900"}`}
      >
  ...
  return (
    <div
      className={`min-h-screen ${isDarkMode ? "bg-slate-900" : "bg-gray-50"} ${isDarkMode ? "text-white" : "text-gray-900"}`}
    >
      {/* Back button and page title */}
      <div
        className={`sticky top-0 z-30 ${isDarkMode ? "bg-slate-900 border-slate-800" : "bg-white border-slate-200"} border-b shadow-sm`}
      >
      ...
      {/* Tabs Navigation */}
      <div
        className={`sticky top-14 z-20 ${isDarkMode ? "bg-slate-900 border-slate-800" : "bg-white border-slate-200"} border-b`}
      >
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {activeTab === "progress" && (
          <div>
            ...
            {sessionProgress.length > 0 ? (
              <div
                className={`mb-6 rounded-xl ${isDarkMode ? "bg-slate-800" : "bg-white border border-slate-200"} overflow-hidden`}
              >
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className={isDarkMode ? "bg-slate-700" : "bg-slate-100"}>
                        <th
                          className={`px-6 py-3 text-left text-xs font-medium ${isDarkMode ? "text-gray-300" : "text-gray-600"} uppercase tracking-wider`}
                        >
                          Session #
                        </th>
                        <th
                    ...
                    <tbody className={`divide-y ${isDarkMode ? "divide-slate-700" : "divide-slate-200"}`}>
                      {sessionProgress.map((session) => (
                        ...
                        >
                          <td
                            className={`px-6 py-4 whitespace-nowrap text-sm ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
                          >
              ...
              <div
                className={`p-8 text-center rounded-lg border-2 border-dashed ${isDarkMode ? "border-slate-700 text-gray-400" : "border-slate-300 text-gray-500"} mb-6`}
              >
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {skills.map((skill) => (
                  <div
                    key={skill.id}
                    className={`p-4 rounded-lg ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"} border`}
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h4 className={`font-medium ${isDarkMode ? "text-white" : "text-slate-900"}`}>{skill.name}</h4>
                      <span className="text-cyan-600 font-medium">{skill.progress}%</span>
                    </div>
                    <div className={`w-full ${isDarkMode ? "bg-slate-700" : "bg-slate-200"} rounded-full h-2 mb-2`}>
        ...
        {activeTab === "attendance" && (
          <div>
            ...
            {isLoadingAttendance ? (
              ...
              <div className={`rounded-xl ${isDarkMode ? "bg-slate-800/80" : "bg-white"} shadow-sm overflow-hidden`}>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className={isDarkMode ? "bg-slate-700" : "bg-slate-100"}>
            ...
            {attendanceRecords.length > 0 && (
              <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div
                  className={`p-4 rounded-lg ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"}`}
                >
        ...
        {activeTab === "course" && (
          <div className="mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                className={`p-6 rounded-lg ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"} border shadow-sm`}
              >
                ...
                <div className="space-y-4">
                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Course Name</p>
                  ...
                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Instructor</p>
                    <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                      {currentEnrollment.request?.Course?.instructor_name || "Not Assigned"}
                    </p>
                  </div>

                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Location</p>
                    <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                      {currentEnrollment.request?.request_location || "Not Specified"}
                    </p>
                  </div>

                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Schedule</p>
                    <div className="space-y-2">
                      {currentEnrollment.request?.requestedSlots?.map((slot, index) => (
                        <div key={index} className="flex items-center">
                          <span className={`capitalize ${isDarkMode ? "text-white" : "text-slate-900"}`}>
                      ...
                      )) || <p className={isDarkMode ? "text-white" : "text-slate-900"}>No schedule information</p>}
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Status</p>
                    <p className={`capitalize ${isDarkMode ? "text-white" : "text-slate-900"}`}>
                  ...
                  <div>
                    ...
                    <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                      {formatDate(currentEnrollment.start_date)}
                    </p>
                  </div>
                  ...
                  {currentEnrollment.end_date && (
                    <div>
                      ...
                      <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                        {formatDate(currentEnrollment.end_date)}
                      </p>
                    </div>
                  )}

                  <div>
                    <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Sessions</p>
                    <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                  ...
                  {currentEnrollment.request?.request_price && (
                    <div>
                      <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-1`}>Course Price</p>
                      <p className={isDarkMode ? "text-white" : "text-slate-900"}>
                        ฿{currentEnrollment.request.request_price.toLocaleString()}
                      </p>
                    </div>
                  )}
                </div>
            ...
            {currentEnrollment.request?.notes && (
              <div
                className={`mt-6 p-6 rounded-lg ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"} border shadow-sm`}
              >
        ...
        {activeTab === "contact" && (
          <div className="mt-6">
            <h2 className="text-xl font-bold mb-6">Send Absense</h2>
            ...
            >
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold mb-2">Max tenison</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        className={`w-full px-3 py-2 rounded-lg ${isDarkMode ? "bg-slate-700 border-slate-600 text-white" : "bg-white border-slate-300 text-slate-900"} border focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500`}
                      >
