...
export default function CourseManagementPage({ params }: { params: { coruseId: string } }) {
  const courseId = Number.parseInt(params.coruseId)
  ...
  useEffect(() => {
    ...
    if (course) {
      ...
      // Redirect to the first course if the requested one doesn't exist
